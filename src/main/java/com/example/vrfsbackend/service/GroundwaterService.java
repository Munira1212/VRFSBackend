...
public class GroundwaterService {
    ...
    private final GroundwaterRepository groundwaterRepository;

    public GroundwaterService() {
        this.groundwaterRepository = new GroundwaterRepository();
    }

    // Fetch weather data from the API
    public JSONObject fetchWeatherData(String apiUrl) throws Exception {
        return groundwaterRepository.fetchAPIData(apiUrl);
    }
